        ...
        <div class="bg-white min-w-full h-full rounded-xl shadow-neutral-400 shadow-lg overflow-scroll p-4">
            <div class="flex flex-col gap-4">
                <div class="flex flex-row justify-between">
                    <h4 class="font-sans text-xl font-bold antialiased md:text-2xl lg:text-3xl text-gray-600">Detail Surat
                    </h4>
                    ...
                    <div id="tab1-group4" class="tab-content text-slate-800 block">
                        <div class="p-4">
                            ...
                            <div class="space-y-1.5">
                                <p class="font-sans  text-sm text-slate-800 dark:text-white font-bold mb-2">Preview Dokumen:
                                </p>
                                @if ($surat->file_path)
                                    <div class="mt-4">
