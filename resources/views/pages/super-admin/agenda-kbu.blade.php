            ...
            <div class="flex-col transition-[max-height] duration-300 ease-in-out max-h-0 mt-1" id="collapseFilterAgendaKbu">
                <form action="{{ route('surat.agendaKbu') }}" method="GET">
                    ...
                    <div class="flex flex-row justify-end mb-5 gap-4 flex-wrap"> {{-- Tambahkan flex-wrap untuk responsivitas tombol --}}
                        ...
                        {{-- Tombol Cetak Agenda Surat Masuk (mode tidak diset atau null) --}}
                        ...
                        {{-- Tombol Cetak Agenda Terima (mode=terima) --}}
                        <button type="submit" name="mode" {{-- Nama input untuk mode --}} value="terima" {{-- Nilai untuk mode 'terima' --}}
                            formaction="{{ route('surat.printAgenda') }}" {{-- Mengarah ke route printAgenda --}} formmethod="GET"
